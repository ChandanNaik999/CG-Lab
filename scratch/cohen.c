...
void cohenSuth()
{
	...
	if (getcode1(fstX, fstY) == 0 && getcode2(sndX, sndY) == 0 && isReject == 0)
	{
...
void main(int argc, char** argv)
{
	...
	printf("First  point code: %d %d %d  %d",code1[0], code1[1], code1[2], code1[3]  );
	printf("Second  point code: %d %d  %d %d",code2[0], code2[1], code2[2], code2[3]  );
